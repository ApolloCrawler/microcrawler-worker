  ...
  _createClass(App, [{
    ...
    value: function main() {
      ...
      this.manager.loadCrawlers().then(function () {
        ...
        var res = [];
        for (var i = 0; i < parseInt(_commander2.default.count, 10); i += 1) {
