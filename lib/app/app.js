...
var DEFAULT_URL = exports.DEFAULT_URL = 'ws://localhost:4000/socket/longpoll?token=undefined&vsn=1.0.0';
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function main() {
      ...
      var socket = new _phoenixSocket.Socket(DEFAULT_URL);
      ...
      // Create channel
      var channel = socket.channel("room:lobby", { token: null });
