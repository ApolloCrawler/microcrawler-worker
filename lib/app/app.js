 ...
 */
function createChannel(socket, channelName, registerPingFunction, unregisterPingFunction) {
  ...
  _createClass(App, [{
    ...
    value: function main() {
      ...
      promise.then(function () {
        ...
        /* const channel = */createChannel(socket, channelName, _this.registerPingFunction.bind(_this), _this.unregisterPingFunction.bind(_this));
      });
    }
  }]);
